...
lazy val googleMaps               = "com.google.maps"      % "google-maps-services" % "0.13.0"
...
lazy val monix                    = "io.monix"             %% "monix"               % "3.2.0"
lazy val okHttpLoggingInterceptor = "com.squareup.okhttp3" % "logging-interceptor"  % "4.5.0"
